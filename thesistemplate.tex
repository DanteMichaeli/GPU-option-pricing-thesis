...
\begin{tikzpicture}[scale=1.1, >=stealth]
    ...
    % Background shading (ITM/OTM)
    \fill[gray!20] (4,-3) -- (6,-3) -- (6,4) -- (4,4) -- cycle;
    \fill[gray!10] (0,-3) -- (4,-3) -- (4,4) -- (0,4) -- cycle;

    % Axes
    \draw[->] (0,0) -- (6,0) node[below,xshift=-25,yshift=-2pt] {$S_T$ (€)};
    \draw[->] (0,-3) -- (0,4) node[above] {Profit (€)};

    % Strike price line
    \draw[dashed] (4,0) -- (4,-0.8) node[above,yshift=35] {\large$K$};
    ...
    \draw (-0.07,-0.8) -- (0,-0.8);
    \node[left] at (-0.1,-0.8) {\small $-p$};
    \node[gray!60] at (3,2.2) {\small \textbf{ITM}};
    \node[gray!60] at (5,2.2) {\small \textbf{OTM}};

\end{tikzpicture}
\caption{Long call option payoff}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\textwidth}
\centering
\begin{tikzpicture}[scale=1.1, >=stealth]
    ...
    % Strike price line
    \draw[dashed] (4,0) -- (4,0.8) node[below,yshift=-35] {\large$K$};
