...
% Path Mode Title
\node[draw=none, font=\bfseries] at (5.5, 6.5) {Path Mode};
% PATH MODE
...
% SLICE MODE
\node[draw=none, font=\bfseries] at (5.5, 2) {Slice Mode};
