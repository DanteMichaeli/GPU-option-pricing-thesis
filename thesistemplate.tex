...
\item The reviewed research employs varying architectures, optimization levels, and performance metrics, making direct quantitative comparison infeasible. Analysis therefore focuses on relative speedup of GPU implementations over their respective CPU baselines, though these speedup factors remain indicative rather than directly comparable due to differences in baseline configurations, core counts, and optimization strategies across studies.
