...
\caption{Summary of GPU acceleration results for option pricing models}
\label{tab:gpu-summary}
...
\hline
MC Basic & 23–59x\tnote{3} & Parallel simulation paths & Parallel random number generation \\
\hline
