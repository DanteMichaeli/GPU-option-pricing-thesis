...
\draw[dotted, line width=1.5pt] (b13.east) -- ++(1.4,0);
\node[draw=none, font=\scriptsize] at (4.7, 5.5) {DIVERGENCE};



% Thread 1 (Blue) - Path 2 (lighter)
\node[rectangle, fill=blue!40, text=white] (b21) at (7, 5) {2.1};
...
\node[rectangle, fill=red!40, text=white] (g21) at (7, 4) {2.1};
...
\draw[dotted, line width=1.5pt] (b23.east) -- ++(1.4,0);
\node[draw=none, font=\scriptsize] at (11.2, 5.5) {DIVERGENCE};
...
\draw[dotted, line width=1.5pt] (sb23.east) -- ++(2.5,0);
\node[draw=none, font=\scriptsize] at (7, 1) {DIVERGENCE};
