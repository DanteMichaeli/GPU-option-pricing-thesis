...
\begin{figure}[H]
    ...
    \begin{scope}[shift={(7.5,2)}]  
        ...
        % Add "ITM" label inside the shaded area (short put ITM is right of K)
        \node[gray!60] at (5,1) {\small \textbf{ITM}};

        % Add "OTM" label inside the shaded area (short put OTM is left of K)
        \node[gray!60] at (1,1) {\small \textbf{OTM}};
